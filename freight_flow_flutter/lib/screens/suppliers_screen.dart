...
class _SuppliersScreenState extends ConsumerState<SuppliersScreen>
          ...
          children: [
            ...
            Expanded(
              child: suppliersAsync.when(
                data: (suppliers) => _buildSuppliersList(suppliers),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Build strong partnerships with reliable suppliers',
                              style: TextStyle(
                                fontSize: 16,
  ...
  Widget _buildBreadcrumb() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.home_rounded, size: 16, color: Colors.purple[600]),
          ...
          Icon(Icons.chevron_right_rounded, size: 16, color: Colors.purple[400]),
          Container(
    ...
    return Row(
      children: [
        ...
        _buildActionButton(
          ...
          label: 'Add Supplier',
          onPressed: () {
            // Navigate to comprehensive supplier onboarding
            context.push('/suppliers/onboarding');
          },
        ),
      ],
    );
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search suppliers by name, email, services...',
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(value: 'Preferred', child: Text('Preferred Partners')),
              ],
              onChanged: (value) {
                setState(() {
  ...
  Widget _buildSuppliersList(List<Supplier> suppliers) {
    ...
    final filteredSuppliers = suppliers.where((supplier) {
      final matchesSearch = _searchQuery.isEmpty ||
          ...
          supplier.city.toLowerCase().contains(_searchQuery);
      
      // For demo purposes, showing all suppliers for 'All' filter
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      _buildHeaderCell('Supplier Name', flex: 3),
                      ...
                      return TweenAnimationBuilder<double>(
                        ...
                        builder: (context, value, child) {
                          return Transform.translate(
                            ...
                            child: Opacity(
                              opacity: value,
                              child: _buildSupplierRow(filteredSuppliers[index], index),
                            ),
                          );
                        },
                      );
              ...
              child: Row(
                children: [
                  ...
                  _buildActionIcon(
                    ...
                    color: Colors.orange,
                    onTap: () => context.go('/trips?supplier=${supplier.id}'),
                    tooltip: 'View Trips',
                  ),
                  const SizedBox(width: 8),
                  _buildActionIcon(
                    ...
                    color: Colors.red,
                    onTap: () => _confirmDeleteSupplier(supplier),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildInfoSection('Address', [
                          _buildInfoRow('Street', supplier.address),
                          _buildInfoRow('City', supplier.city),
                          _buildInfoRow('State', supplier.state ?? 'Not provided'),
                        ]),
                        const SizedBox(height: 24),
                        _buildInfoSection('Business Details', [
                          _buildInfoRow('GST Number', supplier.gstNumber),
                          _buildInfoRow('PAN Number', supplier.panNumber ?? 'Not provided'),
                        ]),
                      ],
                    ),
                  ),
  ...
  void _showEditSupplierDialog(Supplier supplier) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Edit ${supplier.name} functionality coming soon!'),
        backgroundColor: Colors.purple.shade600,
        behavior: SnackBarBehavior.floating,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(12),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text('Delete functionality for ${supplier.name} coming soon!'),
